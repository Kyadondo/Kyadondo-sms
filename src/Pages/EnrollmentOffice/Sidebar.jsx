...
const Sidebar = () => {
  ...
  return (
    <>
    <SidebarContainer>
      <SidebarHeader>Enrollment Portal</SidebarHeader>
      <SidebarNav>
        <SidebarNavItem>
          <SidebarIcon><BsGraphUp /></SidebarIcon>
          <StyledLink to="/EnrollmentOffice/EnrollStudent">Enroll New Student</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/EnrollmentOffice/StatusManagement">Status Management</StyledLink>
        </SidebarNavItem>
       
        <SidebarNavItem>
          <SidebarIcon><BsPencilSquare /></SidebarIcon>
          <StyledLink to="/EnrollmentOffice/UpdateInfo">Update Student Data</StyledLink>
        </SidebarNavItem>
