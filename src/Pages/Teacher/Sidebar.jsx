...
const Sidebar = () => {
  ...
  return (
    ...
    <SidebarContainer style={{ width: isOpen ? '250px' : '80px' }}>
      <SidebarHeader>Teacher's Portal</SidebarHeader>
      <SidebarNav>
        <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/Teacher/AddExamMarks">Add Exam Marks</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/Teacher/AddCoursework">Add CourseWork</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon>< BsChatDots /></SidebarIcon>
          <StyledLink to="/Teacher/Notifications">Notifications</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsDoorOpen /></SidebarIcon>
          <StyledLink to="/Teacher/Log_out">Log out</StyledLink>
        </SidebarNavItem>
